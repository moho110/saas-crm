 ...
 */
@RestController
@RequestMapping("/crm-mytable/callertype")
public class CmfCallertypeController extends BaseController
{
     ...
     * 查询呼叫人类型列表
     */
    @PreAuthorize("@ss.hasPermi('crm-mytable:callertype:list')")
    @GetMapping("/list")
     ...
     * 导出呼叫人类型列表
     */
    @PreAuthorize("@ss.hasPermi('crm-mytable:callertype:export')")
     ...
     * 获取呼叫人类型详细信息
     */
    @PreAuthorize("@ss.hasPermi('crm-mytable:callertype:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增呼叫人类型
     */
    @PreAuthorize("@ss.hasPermi('crm-mytable:callertype:add')")
     ...
     * 修改呼叫人类型
     */
    @PreAuthorize("@ss.hasPermi('crm-mytable:callertype:edit')")
     ...
     * 删除呼叫人类型
     */
    @PreAuthorize("@ss.hasPermi('crm-mytable:callertype:remove')")
