 ...
 */
@RestController
@RequestMapping("/crm-system/systemconfig")
public class CmfSystemconfigController extends BaseController
{
     ...
     * 查询系统配置列表
     */
    @PreAuthorize("@ss.hasPermi('crm-system:systemconfig:list')")
    @GetMapping("/list")
     ...
     * 导出系统配置列表
     */
    @PreAuthorize("@ss.hasPermi('crm-system:systemconfig:export')")
     ...
     * 获取系统配置详细信息
     */
    @PreAuthorize("@ss.hasPermi('crm-system:systemconfig:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增系统配置
     */
    @PreAuthorize("@ss.hasPermi('crm-system:systemconfig:add')")
     ...
     * 修改系统配置
     */
    @PreAuthorize("@ss.hasPermi('crm-system:systemconfig:edit')")
     ...
     * 删除系统配置
     */
    @PreAuthorize("@ss.hasPermi('crm-system:systemconfig:remove')")
